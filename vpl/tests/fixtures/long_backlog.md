...
10. Add CZ_VPL_* env toggles in .env.example for threshold and bucket caps.
11. Ship construct-zero-vpl as a standalone package usable without the voice sidecar.
...
14. Preload STT and TTS optionally via CZ_VOICE_PRELOAD for faster first turn.
